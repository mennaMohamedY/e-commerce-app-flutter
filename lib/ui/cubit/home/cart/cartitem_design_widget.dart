    ...
    return SizedBox(
      ...
      child: Container(decoration: BoxDecoration(border: Border.all(color: AppColors.PrimaryColor,),
        ...
        child:SingleChildScrollView(child: Column(children: [
          Row(children: [
            Expanded(flex:2,child:  Container(clipBehavior: Clip.hardEdge,decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(15.r))),child: Image.asset(AppAssets.commercialImgPath3,height: 120.h, fit: BoxFit.fill,),)),
            SizedBox(width: 12.w,),
            Expanded(flex:5,child: Column(children: [
              Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children: [
                Text("Product Name",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: AppColors.PrimaryColor),),
                Padding(padding:EdgeInsets.only(right: 9.w),child: Icon(Icons.delete_outlined,color: AppColors.PrimaryColor,))
              ],),
              Row(children: [
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(29.r),border: Border.all(color: AppColors.PrimaryColor),color: AppColors.PrimaryColor),
                    child: Row(children: [
                      ...
                      Text("1",style: TextStyle(color: Colors.white,fontSize: 19),),
