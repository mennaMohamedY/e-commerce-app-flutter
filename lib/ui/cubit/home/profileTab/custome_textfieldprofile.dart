...
class CustomeTextFieldProfile extends StatelessWidget {
  ...
  CustomeTextFieldProfile({required this.textFieldTitle,required this.txtController,
  ...
  Widget build(BuildContext context) {
    return
      Padding(padding: EdgeInsets.symmetric(horizontal:4.w ),child: Column(
